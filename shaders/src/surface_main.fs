...
void main() {
    ...
    bool foveationDroppedFragment = filamentFoveationShouldDropFragment();
    ...
    if (foveationDroppedFragment) {
        fragColor = filamentFoveationNeighborColorFallback(fragColor);
    }
